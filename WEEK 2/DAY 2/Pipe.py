...
# =====================================================================
# EVERYTHING BELOW THIS LINE ONLY RUNS WHEN Pipe.py IS EXECUTED DIRECTLY
# (i.e. when another script does `import Pipe`, none of this runs —
#  it only gets the class/objects defined above)
# =====================================================================
